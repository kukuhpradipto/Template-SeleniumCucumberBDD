...
Feature: Validation Amount Total on Overview Page
  ...
  Scenario: Verify amount Total field
    ...
    And user click on the button Add to Cart at product "Sauce Labs Bolt T-Shirt"
    And user click on the button Add to Cart at product "Sauce Labs Fleece Jacket"
